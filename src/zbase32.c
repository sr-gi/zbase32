...
static char encoded_character_lookup[] = {
...
int zbase32_decode(char *decoded, const char *encoded, int bits) {
  char decoded_value, *output = decoded;
  const char *input = encoded;
  int bits_to_read,
      undecoded_bits = bits,
      working_bits = 0,
      working_bit_count = 0;
